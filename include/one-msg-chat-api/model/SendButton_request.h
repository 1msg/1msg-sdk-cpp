...
/*
 * SendButton_request.h
 *
 * 
 */

#ifndef ONEMSG_CHAT_MODEL_SendButton_request_H_
#define ONEMSG_CHAT_MODEL_SendButton_request_H_
...
class  SendButton_request
    : public ModelBase
{
public:
    SendButton_request();
    virtual ~SendButton_request();
    ...
    std::vector<std::shared_ptr<SendButton_request_sections_inner>> getSections() const;
    bool sectionsIsSet() const;
    void unsetSections();
    void setSections(const std::vector<std::shared_ptr<SendButton_request_sections_inner>>& value);
...
protected:
    ...
    std::vector<std::shared_ptr<SendButton_request_sections_inner>> m_Sections;
...
#endif /* ONEMSG_CHAT_MODEL_SendButton_request_H_ */
