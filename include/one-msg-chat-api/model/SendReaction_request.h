...
/*
 * SendReaction_request.h
 *
 * 
 */

#ifndef ONEMSG_CHAT_MODEL_SendReaction_request_H_
#define ONEMSG_CHAT_MODEL_SendReaction_request_H_
...
class  SendReaction_request
    : public ModelBase
{
public:
    SendReaction_request();
    virtual ~SendReaction_request();
...
#endif /* ONEMSG_CHAT_MODEL_SendReaction_request_H_ */
