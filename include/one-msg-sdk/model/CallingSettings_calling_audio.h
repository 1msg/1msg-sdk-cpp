...
/*
 * CallingSettings_calling_audio.h
 *
 * Audio settings (typically response-only)
 */

#ifndef ONEMSG_SDK_MODEL_CallingSettings_calling_audio_H_
#define ONEMSG_SDK_MODEL_CallingSettings_calling_audio_H_
...
/// Audio settings (typically response-only)
/// </summary>
class  CallingSettings_calling_audio
    : public ModelBase
{
public:
    CallingSettings_calling_audio();
    virtual ~CallingSettings_calling_audio();
    ...
    /////////////////////////////////////////////
    /// CallingSettings_calling_audio members
...
#endif /* ONEMSG_SDK_MODEL_CallingSettings_calling_audio_H_ */
