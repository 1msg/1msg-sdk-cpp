...
/*
 * DeleteGroupsGroupId_200_response.h
 *
 * 
 */

#ifndef ONEMSG_CHAT_MODEL_DeleteGroupsGroupId_200_response_H_
#define ONEMSG_CHAT_MODEL_DeleteGroupsGroupId_200_response_H_
...
class  DeleteGroupsGroupId_200_response
    : public ModelBase
{
public:
    DeleteGroupsGroupId_200_response();
    virtual ~DeleteGroupsGroupId_200_response();
    ...
    /////////////////////////////////////////////
    /// DeleteGroupsGroupId_200_response members
    ...
    std::map<utility::string_t, std::shared_ptr<AnyType>> getResponse() const;
    bool responseIsSet() const;
    void unsetResponse();
    void setResponse(const std::map<utility::string_t, std::shared_ptr<AnyType>>& value);
...
protected:
    ...
    std::map<utility::string_t, std::shared_ptr<AnyType>> m_Response;
...
#endif /* ONEMSG_CHAT_MODEL_DeleteGroupsGroupId_200_response_H_ */
