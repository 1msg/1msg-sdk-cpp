...
/*
 * InitiateCallResponse_response.h
 *
 * Present when 1msg wraps an upstream error
 */

#ifndef ONEMSG_SDK_MODEL_InitiateCallResponse_response_H_
#define ONEMSG_SDK_MODEL_InitiateCallResponse_response_H_
...
/// Present when 1msg wraps an upstream error
/// </summary>
class  InitiateCallResponse_response
    : public ModelBase
{
public:
    InitiateCallResponse_response();
    virtual ~InitiateCallResponse_response();
    ...
    /////////////////////////////////////////////
    /// InitiateCallResponse_response members
...
#endif /* ONEMSG_SDK_MODEL_InitiateCallResponse_response_H_ */
