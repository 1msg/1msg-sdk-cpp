...
#ifndef ONEMSG_CHAT_MODEL_BlockUser_request_H_
#define ONEMSG_CHAT_MODEL_BlockUser_request_H_
...
class  BlockUser_request
    : public ModelBase
{
public:
    BlockUser_request();
    virtual ~BlockUser_request();
...
#endif /* ONEMSG_CHAT_MODEL_BlockUser_request_H_ */
