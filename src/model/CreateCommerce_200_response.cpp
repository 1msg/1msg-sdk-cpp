...
CreateCommerce_200_response::CreateCommerce_200_response()
{
    m_Success = false;
...
void CreateCommerce_200_response::validate()
{
    // TODO: implement validation
}

web::json::value CreateCommerce_200_response::toJson() const
{
...
bool CreateCommerce_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateCommerce_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateCommerce_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool CreateCommerce_200_response::isSuccess() const
{
    return m_Success;
}

void CreateCommerce_200_response::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool CreateCommerce_200_response::successIsSet() const
{
    return m_SuccessIsSet;
}

void CreateCommerce_200_response::unsetSuccess()
{
    m_SuccessIsSet = false;
}


std::map<utility::string_t, web::json::value> CreateCommerce_200_response::getAdditionalProperties() const
{
    return m_AdditionalProperties;
}

void CreateCommerce_200_response::setAdditionalProperties(const std::map<utility::string_t, web::json::value>& value)
{
    m_AdditionalProperties = value;
    m_AdditionalPropertiesIsSet = true;
}

void CreateCommerce_200_response::addAdditionalProperty(const utility::string_t& key, const web::json::value& value)
{
    m_AdditionalProperties[key] = value;
    m_AdditionalPropertiesIsSet = true;
}

bool CreateCommerce_200_response::additionalPropertiesIsSet() const
{
    return m_AdditionalPropertiesIsSet;
}

void CreateCommerce_200_response::unsetAdditionalProperties()
{
