...
CreateReadMessage_401_response::CreateReadMessage_401_response()
{
...
void CreateReadMessage_401_response::validate()
{
    // TODO: implement validation
}

web::json::value CreateReadMessage_401_response::toJson() const
{
...
bool CreateReadMessage_401_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void CreateReadMessage_401_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool CreateReadMessage_401_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t CreateReadMessage_401_response::getError() const
{
    return m_Error;
}


void CreateReadMessage_401_response::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool CreateReadMessage_401_response::errorIsSet() const
{
    return m_ErrorIsSet;
}

void CreateReadMessage_401_response::unsetError()
{
    m_ErrorIsSet = false;
}
