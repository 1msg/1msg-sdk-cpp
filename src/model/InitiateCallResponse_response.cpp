...
InitiateCallResponse_response::InitiateCallResponse_response()
{
...
void InitiateCallResponse_response::validate()
{
    // TODO: implement validation
}

web::json::value InitiateCallResponse_response::toJson() const
{
...
bool InitiateCallResponse_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void InitiateCallResponse_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool InitiateCallResponse_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
utility::string_t InitiateCallResponse_response::getError() const
{
    return m_Error;
}


void InitiateCallResponse_response::setError(const utility::string_t& value)
{
    m_Error = value;
    m_ErrorIsSet = true;
}

bool InitiateCallResponse_response::errorIsSet() const
{
    return m_ErrorIsSet;
}

void InitiateCallResponse_response::unsetError()
{
    m_ErrorIsSet = false;
}


std::map<utility::string_t, web::json::value> InitiateCallResponse_response::getAdditionalProperties() const
{
    return m_AdditionalProperties;
}

void InitiateCallResponse_response::setAdditionalProperties(const std::map<utility::string_t, web::json::value>& value)
{
    m_AdditionalProperties = value;
    m_AdditionalPropertiesIsSet = true;
}

void InitiateCallResponse_response::addAdditionalProperty(const utility::string_t& key, const web::json::value& value)
{
    m_AdditionalProperties[key] = value;
    m_AdditionalPropertiesIsSet = true;
}

bool InitiateCallResponse_response::additionalPropertiesIsSet() const
{
    return m_AdditionalPropertiesIsSet;
}

void InitiateCallResponse_response::unsetAdditionalProperties()
{
