...
#include "one-msg-chat-api/model/DeleteFlowsFlowId_200_response.h"

namespace onemsg {
namespace chat {
namespace model {

DeleteFlowsFlowId_200_response::DeleteFlowsFlowId_200_response()
{
    m_Success = false;
...
void DeleteFlowsFlowId_200_response::validate()
{
    // TODO: implement validation
}

web::json::value DeleteFlowsFlowId_200_response::toJson() const
{
...
bool DeleteFlowsFlowId_200_response::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void DeleteFlowsFlowId_200_response::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool DeleteFlowsFlowId_200_response::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(_XPLATSTR(".")))
...
bool DeleteFlowsFlowId_200_response::isSuccess() const
{
    return m_Success;
}

void DeleteFlowsFlowId_200_response::setSuccess(bool value)
{
    m_Success = value;
    m_SuccessIsSet = true;
}

bool DeleteFlowsFlowId_200_response::successIsSet() const
{
    return m_SuccessIsSet;
}

void DeleteFlowsFlowId_200_response::unsetSuccess()
{
    m_SuccessIsSet = false;
}
std::shared_ptr<AnyType> DeleteFlowsFlowId_200_response::getError() const
{
    return m_Error.get();
}


void DeleteFlowsFlowId_200_response::setError(const std::shared_ptr<AnyType>& value)
{
    m_Error = value;
}

bool DeleteFlowsFlowId_200_response::errorIsSet() const
{
    return m_Error.has_value();
}

void DeleteFlowsFlowId_200_response::unsetError()
{
    m_Error.reset();
}


std::map<utility::string_t, web::json::value> DeleteFlowsFlowId_200_response::getAdditionalProperties() const
{
    return m_AdditionalProperties;
}

void DeleteFlowsFlowId_200_response::setAdditionalProperties(const std::map<utility::string_t, web::json::value>& value)
{
    m_AdditionalProperties = value;
    m_AdditionalPropertiesIsSet = true;
}

void DeleteFlowsFlowId_200_response::addAdditionalProperty(const utility::string_t& key, const web::json::value& value)
{
    m_AdditionalProperties[key] = value;
    m_AdditionalPropertiesIsSet = true;
}

bool DeleteFlowsFlowId_200_response::additionalPropertiesIsSet() const
{
    return m_AdditionalPropertiesIsSet;
}

void DeleteFlowsFlowId_200_response::unsetAdditionalProperties()
{
